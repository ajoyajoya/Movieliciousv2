 ...
 */
public class WidgetMovieFavorite extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent toastIntent = new Intent(context, WidgetMovieFavorite.class);
        toastIntent.setAction(WidgetMovieFavorite.TOAST_ACTION);
