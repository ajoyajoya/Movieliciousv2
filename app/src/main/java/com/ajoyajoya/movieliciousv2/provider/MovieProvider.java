...
import static com.ajoyajoya.movieliciousv2.db.DatabaseContract.FavoriteColumns.CONTENT_URI;
...
public class MovieProvider extends ContentProvider {
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        //getContext().getContentResolver().notifyChange(CONTENT_URI, new FavoriteMoviesFragment.DataObserver(new Handler(), getContext()));
